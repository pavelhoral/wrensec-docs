...
#### 3.1.1 New Files
All new JavaScript source files added to Wren Security projects must have a CDDL license header, which includes a copyright line. The header must have the following format:
